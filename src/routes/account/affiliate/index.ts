...
import { IListHistoricalRewardsPayload, ISetOrChangeAffiliateCodePayload } from './types';
...
export class AffilateRoutes {
  ...
  public async list_historical_rewards(payload: IListHistoricalRewardsPayload = {}): Promise<unknown> {
    return this.api.post<unknown, IListHistoricalRewardsPayload>(`${this.baseUri}/history`, payload);
  }
